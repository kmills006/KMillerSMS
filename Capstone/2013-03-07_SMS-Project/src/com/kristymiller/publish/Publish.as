package com.kristymiller.publish
{
	...
	public class Publish extends MovieClip
	{
		...
		public var camNames:Array = Camera.names;
		private var _mic:Microphone;
		public var micNames:Array = Microphone.names;
		...
		// Load Camera
		public function loadCamera(selectedCam:String, selectedMic:int):void{
			...
			_cam = Camera.getCamera(selectedCam);
			_mic = Microphone.getMicrophone(selectedMic);
